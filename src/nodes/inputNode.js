  ...
  return (
    <BaseNode id={id} title="Input" color="#6b7280" outputs={[{id: `${id}-value`}]}>
      <label style={{display: 'block', marginBottom: 6}}>Name: 
        <input value={currName} placeholder="Enter Input.." onChange={(e) => {setCurrName(e.target.value); updateData(e.target.value, inputType)}} 
      ...
      <label>Type: 
        ...
        style={{width: '100%', background: '#0f0f10', border: '1px solid #2a2a2b', color: 'white', borderRadius: 4, padding: 4, marginTop: 4, opacity: 0.9}}>
